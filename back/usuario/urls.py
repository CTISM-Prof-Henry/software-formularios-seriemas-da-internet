...
urlpatterns = [
    ...
    path('api/recuperar-senha/', views.reset_senha, name='reset_senha'),
    path('api/confirmar-senha-nova/', views.confirmar_reset_senha, name='confirmar_reset_senha'),
    ...
    path('api/usuarios/buscar/', views.buscar_usuarios_by_name, name='buscar_usuarios_by_name'),
